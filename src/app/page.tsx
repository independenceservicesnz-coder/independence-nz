...
const providers = [
  { id: '1', name: 'Pristine Home Services', cat: 'Home Cleaning', location: 'Auckland Central', rating: 4.9, reviews: 128, price: '$85 / visit', avail: 'Available tomorrow', emoji: '🧹', bg: 'from-emerald-50 to-emerald-100', topRated: true },
  { id: '2', name: 'Green Thumb Gardens', cat: 'Gardening', location: 'North Shore', rating: 4.8, reviews: 94, price: '$65 / hour', avail: 'Available Friday', emoji: '🌿', bg: 'from-emerald-50 to-amber-50', topRated: false },
  { id: '3', name: 'Reliable Handyman Co.', cat: 'Handyman', location: 'Manukau', rating: 4.7, reviews: 61, price: '$75 / hour', avail: 'Available Monday', emoji: '🔧', bg: 'from-violet-50 to-purple-100', topRated: false },
  { id: '4', name: 'MoveBetter Health', cat: 'Fitness & Mobility', location: 'Remuera', rating: 5.0, reviews: 47, price: '$90 / session', avail: 'Available today', emoji: '🏃', bg: 'from-rose-50 to-pink-100', topRated: true },
]
...
const howItWorks = [
  ...
  { n: '3', title: 'Book & pay securely', desc: 'Choose a time and pay safely through Independence NZ' },
      ...
      <section className="bg-gradient-to-br from-brand-700 via-brand-500 to-brand-400 text-white">
        <div className="max-w-6xl mx-auto px-4 py-20 text-center">
          ...
          <p className="text-lg text-white/80 max-w-xl mx-auto mb-8 leading-relaxed">
            Browse vetted local providers, book in minutes, pay securely — and rate your experience.
          </p>
          <HeroSearch />
          <div className="flex flex-wrap justify-center gap-6 mt-10 pt-10 border-t border-white/15 text-sm text-white/70">
            {[['2,400+', 'Happy customers'], ['200+', 'Vetted providers'], ['4.9★', 'Average rating'], ['98%', 'Satisfaction']].map(([v, l]) => (
        ...
        <div className="rounded-2xl overflow-hidden h-72 md:h-96 relative">
          <img
src="https://images.unsplash.com/photo-1726176682983-7d4e7b937b0a?w=1200&q=80"
          ...
          {providers.map(p => (
            <div key={p.id} className="bg-white rounded-xl border border-gray-100 overflow-hidden hover:shadow-lg transition-all group">
              ...
              <div className="p-4">
                ...
                <p className="text-xs text-gray-500 mb-3">From <strong className="text-gray-700">{p.price}</strong></p>
                <div className="flex items-center justify-between pt-3 border-t border-gray-50">
                  ...
                  <BookingModal providerName={p.name} price={85} serviceName="Standard service" />
                </div>
              </div>
            </div>
          ))}
