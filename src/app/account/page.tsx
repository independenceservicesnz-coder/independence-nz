    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-400 text-sm mt-1">
          Manage your bookings, reviews, and account settings.
        </p>
      </div>
      ...
      <div className="card overflow-hidden">
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-50">
          ...
          <Link href="/account/bookings" className="text-xs text-brand-500">
            View all →
          </Link>
        </div>
        {upcoming.length === 0 ? (
      ...
      <div className="grid grid-cols-2 gap-4">
        <Link
          href="/browse"
          className="bg-brand-500 hover:bg-brand-600 text-white rounded-xl p-5 transition-colors block"
        >
        ...
        <Link
          ...
          className="card hover:border-brand-200 p-5 block transition-colors"
        >
