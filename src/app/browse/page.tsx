...
const ALL_PROVIDERS = [
  ...
  { id: '7', name: 'Care Connect NZ', cat: 'care', catLabel: 'Personal Care', location: 'Takapuna', rating: 4.9, reviews: 38, price: 55, priceLabel: '$55 / hour', avail: 'Available tomorrow', emoji: '🤝', bg: 'from-pink-50 to-rose-50', topRated: false },
